...
class DataIngestion:
    ...
    def export_data_into_feature_store(self)->DataFrame:
        ...
        """
        try:
            logging.info("Exporting data from mongoDB collection into feature store")
            ...
            logging.info("Exporting data from mongoDB collection into feature store completed")
            return dataframe
    ...
    def split_data_as_train_test_split(self,dataframe:DataFrame)->None:
        """
        split the feature store data into train and test data
        """
        try:
    ...
    def initiate_data_ingestion(self)->DataIngestionArtifact:
        try:
            ...
            dataframe.drop(self._schema_config["drop_columns"],inplace=True,axis=1)
