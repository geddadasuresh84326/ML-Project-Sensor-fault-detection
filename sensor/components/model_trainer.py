    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            if classfication_train_metric.f1_score <= self.model_trainer_config.expected_accuracy:
                raise Exception("Model is not good to provide expected accuracy ")
            ...
            model_trainer_artifact = ModelTrainerArtifact(trained_model_file_path=self.model_trainer_config.trained_model_file_path,train_metric_artifact=classfication_train_metric,test_metric_artifact=classfication_test_metric)
